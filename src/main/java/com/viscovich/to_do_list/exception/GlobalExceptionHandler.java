...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler (TaskIncompleteDataException.class)
    public ResponseEntity<String> handleTaskIncompleteDataException(TaskIncompleteDataException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ex.getMessage());
    }

    @ExceptionHandler(org.springframework.dao.DataIntegrityViolationException.class)
    public ResponseEntity<String> handleDuplicateEntry(org.springframework.dao.DataIntegrityViolationException ex) {
